...
export function Skills () {
    ...
    return(
        <>
            ...
            className="grid grid-cols-3 grid-rows-2 w-4/5 max-4-[400px] mx-auto mt-10 gap-12">
                {skillsData.map((item, index) => {
                    return(
                        ...
                        >
                            <p className="text-3xl nunito-sans-bold text-center mb-8 bg-gradient-to-br from-slate-300 via-blue-400 to-purple-400 bg-clip-text text-transparent">
                                {item.title}
                            </p>
