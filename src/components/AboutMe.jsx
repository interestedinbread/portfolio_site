...
export function AboutMe() {
    return(
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-y-8 md:gap-18 w-4/5 mx-auto bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900 p-4 md:p-12 rounded-[2rem]">
