...
export function Testimonials() {
    ...
    return(
        <>
            <h2 className="nunito-sans-bold text-5xl mt-24 mb-12 text-cyan-300 text-center">Testimonials</h2>
            <div className="flex w-4/5 mx-auto mt-24 bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900 p-12 rounded-[2rem]">
